...
The chapter is organized as follows: sections \ref{sec:model} and 
...
\begin{figure}[]
\centering
\subfloat[SNR=$1$]{\begin{overpic}[width=0.4\linewidth]{figures/compare_ims_snr1by1_6454}
\put(6,52){\tiny Clean}
\put(32,52){\tiny Noisy}
\put(55,52){\tiny TWF}
\put(80,52){\tiny CWF}
...
\quad
\subfloat[SNR=$1/20$]{\begin{overpic}[width=0.4\linewidth]{figures/compare_ims_snr1by20_6454}%
%\put(5,40){Clean}
\end{overpic}%
\label{a}}\\
\subfloat[SNR=$1/40$]{\begin{overpic}[width=0.4\linewidth]{figures/compare_ims_snr1by40_6454}%
%\put(5,40){Clean}
\end{overpic}%
\label{b}}
\quad
\subfloat[SNR=$1/60$]{\begin{overpic}[width=0.4\linewidth]{figures/compare_ims_snr1by60_6454}%
%\put(5,40){Clean}
\end{overpic}%
\label{c}}
...
\begin{figure}[]
\centering
\subfloat[]{\begin{overpic}[width=0.7\linewidth]{figures/mse_snr_6454}%
\end{overpic}%
\label{fig:mse_snr}}\\
\subfloat[]{\begin{overpic}[width=0.7\linewidth]{figures/mse_nims_6454}
\end{overpic}
\label{fig:mse_nims}}
...
% \begin{figure}[]
% \centering
% \subfloat[SNR=$1$]{\begin{overpic}[width=0.4\linewidth]{compare_ims_snr1by1_6454}
% \put(6,62){\tiny Clean}
% \put(32,62){\tiny Noisy}
% \put(55,62){\tiny TWF}
% \put(80,62){\tiny CWF}
...
\begin{figure}[]
\centering
\subfloat[SNR=$1$]{\begin{overpic}[width=0.45\linewidth]{figures/compare_ims_col_snr1by1_6454}
\put(6,52){\tiny Clean}
\put(32,52){\tiny Noisy}
\put(55,52){\tiny TWF}
\put(80,52){\tiny CWF}
...
\quad
\subfloat[SNR=$1/10$]{\begin{overpic}[width=0.45\linewidth]{figures/compare_ims_col_snr1by10_6454}%
\end{overpic}%
\label{}}

\subfloat[SNR=$1/20$]{\begin{overpic}[width=0.45\linewidth]{figures/compare_ims_col_snr1by20_6454}%
\end{overpic}%
\label{}}
...
\begin{figure}[]
\centering
\subfloat[]{\begin{overpic}[width=0.6\linewidth]{figures/raw_title}%
\end{overpic}%
\label{fig:raw_outlier}}
\quad
\subfloat[]{\begin{overpic}[width=0.6\linewidth]{figures/den_title}
\end{overpic}
\label{fig:den_outlier}} \\
\subfloat[]{\begin{overpic}[width=0.125\linewidth]{figures/mean_image}%
\end{overpic}%
\label{fig:mean_image}}
\quad
\subfloat[]{\begin{overpic}[width=0.7\linewidth]{figures/top_eigim}
\end{overpic}
\label{fig:eigenims}}
